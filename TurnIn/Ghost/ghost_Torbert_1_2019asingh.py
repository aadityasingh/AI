...
print("6. When playing with more than 2 players, use the pipe (|) to get a good letter.")
...
# Still experimental... Not guaranteed to be the best (This method is called "Help for Dummies")
